...
printf '\n== Reboot the EC2 instance through the AWS CLI ==\n'
...
if [[ "$ANSIBLE_REACHABLE" -ne 1 ]]; then
    ...
    fail "Ansible could not connect after the EC2 reboot."
fi
